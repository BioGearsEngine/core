...
# ::
#
#   Java_JNI_INCLUDE_DIR      = the full path to the Java jdk include folder
#   Java_JNI_PLATFORM_INCLUDE_DIR = the full path current platforms subdirectory in Java jdk include folder
...
#   Java_XML_EXECUTABLE       = the full path to the Java XML Schema Compiler
...
if(Java_JAVA_EXECUTABLE)
    ...
    # Look for the JNI header file
    get_filename_component(_JAVA_EXECUTABLE_HOME ${Java_JAVA_EXECUTABLE} DIRECTORY )
    find_path(Java_JNI_INCLUDE_DIR
          NAMES jni.h
          PATH_SUFFIXES
					 include/
          PATHS ${JAVA_HOME}
    ...
    find_path(Java_JNI_PLATFORM_INCLUDE_DIR
          NAMES jni_md.h
          PATH_SUFFIXES
					include/linux
					include/win32
...
set(Java_INCLUDE_DIRS ${Java_JNI_INCLUDE_DIR} ${Java_JNI_PLATFORM_INCLUDE_DIR})
