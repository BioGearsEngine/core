...
#include <atomic>
std::unique_ptr<SESubstanceCompound> makeSubstanceCompound(std::unique_ptr<biogears::BioGearsEngine>& engine)
{
...
bool mixSubstanceCompound(std::unique_ptr<biogears::BioGearsEngine>& engine, std::unique_ptr<SESubstanceCompound>& compound, const char* substance, double concentration, MassPerVolumeUnit unit)
{
...
std::string registerCompoundbiogears(std::unique_ptr<biogears::BioGearsEngine>& engine, std::unique_ptr<SESubstanceCompound>&& compound)
{
...
bool infuseCompound(std::unique_ptr<biogears::BioGearsEngine>& engine, std::string compound_name, double volume, VolumeUnit volume_unit, double rate, VolumePerTimeUnit rate_unit)
{
...
int HowToInfusionDrug()
{
  ...
  auto bg = std::make_unique<BioGearsEngine>("HowTo-InfusionCustomDrug.log");
