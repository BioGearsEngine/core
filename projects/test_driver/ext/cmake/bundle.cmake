...
if(EXISTS "${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/test_driver${CONFIG_SUFFIX}${CMAKE_EXECUTABLE_SUFFIX}")
  fixup_bundle("${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/test_driver${CONFIG_SUFFIX}${CMAKE_EXECUTABLE_SUFFIX}"
                 ""
