...
namespace biogears {
  namespace scsp {
    ...
    //!
    template<class C>
    Source<C>::Source(std::shared_ptr<C> c)
      :_container(c)
    {}
    //--------------------------------------------------------------------------
    //!
    ...
    Channel<C>::Channel()
      ...
      , _source(Source<C>::make_unique(_container))
    {  }
    //--------------------------------------------------------------------------
    //!
    //!  Constructs a Channel and stands up an internal container
    ...
    //!
    template<class C>
    auto Channel<C>::as_source() -> std::unique_ptr<Source<C>>
    {
