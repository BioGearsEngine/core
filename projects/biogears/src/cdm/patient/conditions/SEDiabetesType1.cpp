...
SEDiabetesType1::SEDiabetesType1() : SEPatientCondition()
{
...
void SEDiabetesType1::ToString(std::ostream &str) const
{
	...
	if(HasComment())
		str<<"\n\tComment: "<<m_Comment;
	str << "\n\tDiabetes Type 1 Insulin Production Severity: "; HasInsulinProductionSeverity() ? str << m_InsulinProductionSeverity : str << "NaN";
	str << std::flush;
}