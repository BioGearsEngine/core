...
SEDiabetesType2::SEDiabetesType2() : SEPatientCondition()
{
...
void SEDiabetesType2::ToString(std::ostream &str) const
{
	...
	if(HasComment())
		str<<"\n\tComment: "<<m_Comment;
	str << "\n\tDiabetes Type 2 Insulin Production Severity: "; HasInsulinProductionSeverity() ? str << m_InsulinProductionSeverity : str << "NaN";
  str << "\n\tDiabetes Type 2 Insulin Resistance Severity: "; HasInsulinResistanceSeverity() ? str << m_InsulinResistanceSeverity : str << "NaN";
	str << std::flush;
}