...
BioGearsEngineTest::BioGearsEngineTest() : Loggable(new Logger()) {
  myLogger = true;
  FillFunctionMap();
}

BioGearsEngineTest::BioGearsEngineTest(Logger *logger) : Loggable(logger) {
  myLogger = false;
  FillFunctionMap();
}
...
void BioGearsEngineTest::FillFunctionMap() {
  ...
  // one we want
  testFunction cardioCTTest =
      &BioGearsEngineTest::CardiovascularCircuitAndTransportTest;
  testFunction cardioBGTest = &BioGearsEngineTest::CardiovascularBloodGasesTest;
  testFunction cardioTuneCircuitTest =
      &BioGearsEngineTest::TuneCardiovascularCircuitTest;
  testFunction respCTTest =
      &BioGearsEngineTest::RespiratoryCircuitAndTransportTest;
  testFunction anesthCTTest =
      &BioGearsEngineTest::AnesthesiaMachineCircuitAndTransportTest;
