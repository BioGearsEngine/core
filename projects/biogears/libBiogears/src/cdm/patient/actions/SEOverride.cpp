...
{
  return (m_OverrideState == SEOnOff::Off) ? true : (m_OverrideState == SEOnOff::On) ? true
                                                                                                   : false;
}
...
{
  return (m_OverrideConformance == SEOnOff::Off) ? true : (m_OverrideConformance == SEOnOff::On) ? true
                                                                                                               : false;
}
void SEOverride::InvalidateOverrideConformance()
{
  m_OverrideConformance = (SEOnOff::Off);
}
