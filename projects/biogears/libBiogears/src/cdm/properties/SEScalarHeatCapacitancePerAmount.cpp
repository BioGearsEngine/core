...
//-------------------------------------------------------------------------------
bool SEScalarHeatCapacitancePerAmount::Load(const CDM::ScalarHeatCapacitancePerAmountData& in)
{
...
void SEScalarHeatCapacitancePerAmount::Unload(CDM::ScalarHeatCapacitancePerAmountData& data) const
{
