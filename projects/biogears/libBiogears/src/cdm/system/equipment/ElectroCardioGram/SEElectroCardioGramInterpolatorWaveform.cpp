...
CDM::ElectroCardioGramWaveformLeadNumberData SEElectroCardioGramInterpolatorWaveform::GetLeadNumber() const
{
  return m_LeadNumber;
}
void SEElectroCardioGramInterpolatorWaveform::SetLeadNumber(CDM::ElectroCardioGramWaveformLeadNumberData n)
{
  m_LeadNumber = n;
}
