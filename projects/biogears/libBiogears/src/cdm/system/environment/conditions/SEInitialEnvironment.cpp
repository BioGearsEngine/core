...
//-----------------------------------------------------------------------------
bool SEInitialEnvironment::operator==(SEInitialEnvironment const& rhs) const
{
  if (this == &rhs)
    return true;
  ...
  return m_Comment == rhs.m_Comment
    ...
    && m_ConditionsFile == rhs.m_ConditionsFile
...
//-------------------------------------------------------------------------------
bool SEInitialEnvironment::operator==(SECondition const& rhs) const
{
  if (this == &rhs)
    return true;
  try {
    auto initialEnvironment = dynamic_cast<SEInitialEnvironment const&>(rhs);
    return this->operator==(initialEnvironment);
  } catch (std::exception) {
    return false;
  }
  return false;
