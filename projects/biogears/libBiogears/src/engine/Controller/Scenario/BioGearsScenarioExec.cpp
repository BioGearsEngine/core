...
namespace biogears {
BioGearsScenarioExec::BioGearsScenarioExec(BioGearsEngine& engine)
...
{
  try {
    bool success = RunScenario(scenario, resultsFile, cExec);
    return success;
...
bool BioGearsScenarioExec::Execute(const std::string& scenarioFile, const std::string& resultsFile, SEScenarioCustomExec* cExec)
{
  try {
    ...
    bool success = RunScenario(scenario, rFile, cExec);
    return success;
  } catch (CommonDataModelException& ex) {
    Error(ex.what());
  } catch (...) {
...
//-----------------------------------------------------------------------------
bool BioGearsScenarioExec::Execute(const char* scenarioFile, const char* resultsFile, SEScenarioCustomExec* cExec)
{
  return Execute(std::string { scenarioFile }, std::string { resultsFile }, cExec);
}
//-----------------------------------------------------------------------------
bool BioGearsScenarioExec::Execute(SEScenario const& scenario, const char* resultsFile, SEScenarioCustomExec* cExec)
{
  return Execute(scenario, std::string { resultsFile }, cExec);
}
//-----------------------------------------------------------------------------
bool BioGearsScenarioExec::RunScenario(SEScenario const& scenario, const std::string& resultsFile, SEScenarioCustomExec* cExec)
{
...
//-----------------------------------------------------------------------------
bool BioGearsScenarioExec::RunScenario(const std::string& scenarioFile, const std::string& resultsFile, SEScenarioCustomExec* cExec)
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
bool BioGearsScenarioExec::ProcessActions(SEScenario& scenario)
{
...
//-----------------------------------------------------------------------------
bool BioGearsScenarioExec::ProcessAction(const SEAction& action)
{
