...
void BloodChemistry::InflammatoryResponse()
{
  ...
  double fractureSeverity = 0.0;

  /*
  m_data.GetDataTrack().Probe("macrophages ", m_InflammatoryResponse->GetMacrophageActive().GetValue());
  m_data.GetDataTrack().Probe("neutrophils ", m_InflammatoryResponse->GetNeutrophilActive().GetValue());
  m_data.GetDataTrack().Probe("trauma ", m_InflammatoryResponse->GetTrauma().GetValue());
  */
