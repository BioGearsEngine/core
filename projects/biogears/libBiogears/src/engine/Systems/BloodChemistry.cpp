...
bool BloodChemistry::Load(const CDM::BioGearsBloodChemistrySystemData& in)
{
  ...
  io::Property::UnMarshall(in.ArterialOxygenAverage_mmHg(), m_ArterialOxygen_mmHg);
  io::Property::UnMarshall(in.ArterialCarbonDioxideAverage_mmHg(), m_ArterialCarbonDioxide_mmHg);
...
void BloodChemistry::Unload(CDM::BioGearsBloodChemistrySystemData& data) const
{
  ...
  data.ArterialOxygenAverage_mmHg(std::make_unique<CDM::RunningAverageData>());
  io::Property::Marshall(m_ArterialOxygen_mmHg, data.ArterialOxygenAverage_mmHg());

  data.ArterialCarbonDioxideAverage_mmHg(std::make_unique<CDM::RunningAverageData>());
  io::Property::Marshall(m_ArterialCarbonDioxide_mmHg, data.ArterialCarbonDioxideAverage_mmHg());
