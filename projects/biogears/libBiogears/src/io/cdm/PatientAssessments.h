...
#define CDM_PATIENT_ASSESSMENTS_PTR_MARSHALL_HELPER(in, out, func)                       \
  if (in.m_##func) {                                                                 \
    out.func(std::make_unique<std::remove_reference<decltype(out.func())>::type>()); \
    io::PatientAssessments::Marshall(*in.m_##func, out.func());                      \
  }

#define CDM_OPTIONAL_PATIENT_ASSESSMENTS_PTR_MARSHALL_HELPER(in, out, func) \
  if (in.m_##func) {                                                    \
    io::PatientAssessments::Marshall(*in.m_##func, out.func());         \
  }

#define SE_PATIENT_ASSESSMENT_ENUM_PTR_MARSHALL_HELPER(in, out, func)                    \
  if (in.Has##func()) {                                                              \
    out.func(std::make_unique<std::remove_reference<decltype(out.func())>::type>()); \
    io::PatientAssessments::Marshall(in.m_##func, out.func());                       \
  }

#define SE_OPTIONAL_PATIENT_ASSESSMENT_ENUM_PTR_MARSHALL_HELPER(in, out, func) \
  io::PatientAssessments::Marshall(in.m_##func, out.func());
