...
namespace io {
  ...
  {
    Scenario::UnMarshall(static_cast<const CDM::ConditionData&>(in), static_cast<SECondition&>(out));
  }
  //----------------------------------------------------------------------------------
  void PatientConditions::Marshall(const SEPatientCondition& in, CDM::PatientConditionData& out)
  {
    Scenario::Marshall(static_cast<const SECondition&>(in), static_cast<CDM::ConditionData&>(out));
  }
  // SEChronicAnemia
