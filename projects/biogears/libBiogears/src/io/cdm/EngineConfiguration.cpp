...
namespace io {
  ...
  void EngineConfiguration::Marshall(const PhysiologyEngineConfiguration& in, CDM::PhysiologyEngineConfigurationData& out)
  {
    ...
    if (in.HasTimeStep())
      io::Property::Marshall(*in.m_TimeStep, out.TimeStep());
  ...
  {
    io::Property::Marshall(*in.m_ConvergenceTime, out.ConvergenceTime());
    io::Property::Marshall(*in.m_MinimumReactionTime, out.MinimumReactionTime());
    io::Property::Marshall(*in.m_MaximumAllowedStabilizationTime, out.MaximumAllowedStabilizationTime());
