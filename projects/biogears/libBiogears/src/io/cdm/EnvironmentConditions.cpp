...
namespace io {
  ...
  {
    io::Scenario::UnMarshall(static_cast<const CDM::ConditionData&>(in), static_cast<SECondition&>(out));
  }
  //----------------------------------------------------------------------------------
  void EnvironmentConditions::Marshall(const SEEnvironmentCondition& in, CDM::EnvironmentConditionData& out)
  {
    io::Scenario::Marshall(static_cast<const SECondition&>(in), static_cast<CDM::ConditionData&>(out));
  }
  //----------------------------------------------------------------------------------
  ...
  {
    io::Scenario::UnMarshall(static_cast<const CDM::EnvironmentConditionData&>(in), static_cast<SEEnvironmentCondition&>(out));
  ...
  {
    io::Scenario::Marshall(static_cast<const SEEnvironmentCondition&>(in), static_cast<CDM::EnvironmentConditionData&>(out));
    if (in.HasConditions())
