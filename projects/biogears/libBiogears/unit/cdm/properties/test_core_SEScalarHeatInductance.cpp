...
#ifdef DISABLE_BIOGEARS_SEScalarHeatInductance_TEST
#define TEST_FIXTURE_NAME DISABLED_SEScalarHeatInductance_Fixture
#else
#define TEST_FIXTURE_NAME SEScalarHeatInductance_Fixture
#endif
