...
#ifdef DISABLE_BIOGEARS_SEScalarVolumePerTimePressure_TEST
#define TEST_FIXTURE_NAME DISABLED_SEScalarVolumePerTimePressure_Fixture
#else
#define TEST_FIXTURE_NAME SEScalarVolumePerTimePressure_Fixture
#endif
