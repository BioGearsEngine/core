...
#ifdef DISABLE_BIOGEARS_SEScalarMassPerMass_TEST
#define TEST_FIXTURE_NAME DISABLED_SEScalarMassPerMass_Fixture
#else
#define TEST_FIXTURE_NAME SEScalarMassPerMass_Fixture
#endif
