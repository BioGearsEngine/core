...
#ifdef DISABLE_BIOGEARS_SEScalarMassPerAreaTime_TEST
#define TEST_FIXTURE_NAME DISABLED_SEScalarMassPerAreaTime_Fixture
#else
#define TEST_FIXTURE_NAME SEScalarMassPerAreaTime_Fixture
#endif
