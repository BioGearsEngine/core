...
#ifdef DISABLE_BIOGEARS_SEScalarVolumePerTimeArea_TEST
#define TEST_FIXTURE_NAME DISABLED_SEScalarVolumePerTimeArea_Fixture
#else
#define TEST_FIXTURE_NAME SEScalarVolumePerTimeArea_Fixture
#endif
