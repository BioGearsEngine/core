...
#ifdef DISABLE_BIOGEARS_SEScalarPressureTimePerArea_TEST
#define TEST_FIXTURE_NAME DISABLED_SEScalarPressureTimePerArea_Fixture
#else
#define TEST_FIXTURE_NAME SEScalarPressureTimePerArea_Fixture
#endif
