...
#ifdef DISABLE_BIOGEARS_SEScalarElectricPotential_TEST
#define TEST_FIXTURE_NAME DISABLED_SEScalarElectricPotential_Fixture
#else
#define TEST_FIXTURE_NAME SEScalarElectricPotential_Fixture
#endif
