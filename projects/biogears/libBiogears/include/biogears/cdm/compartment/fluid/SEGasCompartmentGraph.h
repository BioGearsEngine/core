...
public:
  ...
  bool Load(const CDM::GasCompartmentGraphData& in, SECompartmentManager& cmptMgr);
  CDM::GasCompartmentGraphData* Unload();

protected:
  void Unload(CDM::GasCompartmentGraphData& data);
