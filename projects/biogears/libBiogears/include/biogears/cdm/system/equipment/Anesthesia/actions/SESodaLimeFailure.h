...
public:
  ...
  SESodaLimeFailure();
  virtual ~SESodaLimeFailure() override;
  ...
  virtual bool Load(const CDM::SodaLimeFailureData& in, std::random_device* rd = nullptr);
...
public:
  ...
  bool operator==(SESodaLimeFailure const& rhs) const;
  bool operator!=(SESodaLimeFailure const& rhs) const;
