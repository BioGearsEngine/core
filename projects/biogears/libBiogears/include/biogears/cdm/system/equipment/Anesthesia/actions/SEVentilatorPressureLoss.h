...
class BIOGEARS_API SEVentilatorPressureLoss : public SEAnesthesiaMachineAction {
public:
  friend io::AnesthesiaActions;
  SEVentilatorPressureLoss();
  virtual ~SEVentilatorPressureLoss() override;
  ...
  virtual bool Load(const CDM::VentilatorPressureLossData& in, std::random_device* rd = nullptr);
...
public:
  ...
  bool operator==(SEVentilatorPressureLoss const& rhs) const;
  bool operator!=(SEVentilatorPressureLoss const& rhs) const;
