...
extern template class SEScalarQuantity<PressureTimePerVolumeAreaUnit>;
using SEScalarPressureTimePerVolumeArea  = SEScalarQuantity<PressureTimePerVolumeAreaUnit>;
