...
BG_EXT template class BIOGEARS_API SEScalarQuantity<PressurePerVolumeUnit>;
...
public:
  ...
  bool Load(const CDM::ScalarPressurePerVolumeData& in);

protected:
  virtual void Unload(CDM::ScalarPressurePerVolumeData& data) const;
