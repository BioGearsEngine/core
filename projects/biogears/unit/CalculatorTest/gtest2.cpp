...
TEST(CalculatorTest2, AdditionTest)
{
	double _A = 5;
	double _B = 4;
...
TEST(CalculatorTest2, SubtractionTest)
{
	double _A = 5;
	double _B = 4;
...
TEST(CalculatorTest2, MultiTest)
{
	double _A = 5;
	double _B = 4;
...
TEST(CalculatorTest2, DivisionTest)
{
	double _A = 5;
	double _B = 4;
...
TEST(CalculatorTest2, MinusTest)
{
	double _A = 5;
	double _B = 4;
...
TEST(CalculatorTest2, QuotientTest)
{
	double _A = 5;
	double _B = 4;
