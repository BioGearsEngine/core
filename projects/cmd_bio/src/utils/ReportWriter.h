...
private:
  ...
  const char* table_row_begin_green;
  const char* table_row_begin_red;
  const char* table_row_begin_yellow;
  const char* table_second_line;
  const char* table_item_begin;
  const char* table_item_end;
