...
|	---	|	---	|	---	|	---	|	---	|	---	|	---	|	---	|	---	|	---	|
|	%Environment File Change to an altitude of 3000 meters	|	Atmospheric pressure at 3000m is approximately 70 kPa	|	50 s	|	950	|<span class="warning">	7% increase @cite zhang2014highaltitude	</span>|<span class="success">	7% decrease @cite zhang2014highaltitude	|<span class="success">	5% increase @cite zhang2014highaltitude	</span>|<span class="success">	Decrease @cite bartsch2007highaltitude	</span>|<span class="success">	No change @cite bartsch2007highaltitude	</span>|<span class="success">	Increase @cite bartsch2007highaltitude	</span>|
