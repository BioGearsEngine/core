...
Drugs administered orally are transported to the bloodstream via an advanced compartment and transit (ACAT) model.  Examples of ACAT models with varying numbers of compartments are plentiful in the literature; the BioGears implementation follows the work of @cite yang2016application and @cite almukainzi2014modelling.  The gastrointestinal track is divided into nine regions in which both solid and dissolved drug concentrations are tracked:  Stomach, Duodenum, Jejunum 1, Jejunum 2, Ileum 1, Ileum 2, Ileum 3, Cecum, and Ascending Colon.  The rate of mass transit between compartments is governed by first order rate constants defined in @cite yang2016application, while the rate of drug dissolution within each compartment is determined by the Noyes-Whitney equation @cite yang2016application.  Every compartment except the stomach exchanges dissolved drug mass via permeation with an enterocyte layer from which drug is deposited in the portal vein.
The rate of permeation from each region depends on the local pH and drug-specific parameters (LogP, pKa, molecular weight, polar surface area, number of hydrogen bonds) as outlined in @cite wolk2019segmental.

#### Oral (Transmucosal)

BioGears has develeloped a specialized model for administration of oral transmucosal fentanyl citrate (OTFC).  Fentanyl is deposited as a solid in the mouth and its rate of dissolution is calculated via the Noyes-Whiney equation.  Dissolved fentanyl diffuses through the oral mucosal layer into the systemic circulation.  We solve the diffusion equation by discretizing the oral mucosal barrier into thin layers and applying a central finite difference strategy.  The physical properties of the mucosal layer (surface area, thickness) were obtained from @cite xia2015development @cite zhang2002oral @cite sattar2014oral.  A large fraction of the dissolved fentanyl is swallowed and enters the stomach compartment of the ACAT model described above, after which it is subjected to first-pass metabolism.  In this way, approxiamtely 50% of the fentanyl reaches the systemic circulation, which is in line with observations in pharmacokinetic studies @cite streisand1991absorption @cite streisand1998dose. 
...
|	Desflurane	|	6% Desflurane breathed in through mask	|<span class="success">	4	</span>|<span class="warning">	2	</span>|<span class="danger">	0	</span>|
|	Epinephrine	|	Adminster 10 ug injection of Epinephrine	|<span class="success">	4	</span>|<span class="warning">	1	</span>|<span class="danger">	0	</span>|
...
|	Furosemide	|	Administer 40 mg of Furosemide	|<span class="success">	3	</span>|<span class="warning">	1	</span>|<span class="danger">	0	</span>|
...
|	Morphine	|	Administer 2.75 mg/min IV Morphine for 4 minutes	|<span class="success">	5	</span>|<span class="warning">	0	</span>|<span class="danger">	0	</span>|
...
|	Pralidoxime	|	Adminster 700 mg injection of Pralidoxime	|<span class="success">	5	</span>|<span class="warning">	0	</span>|<span class="danger">	0	</span>|
...
|	Propofol	|	Administer 135 mg injection of Propofol	|<span class="success">	4	</span>|<span class="warning">	0	</span>|<span class="danger">	0	</span>|
|	Rocuronium	|	Administer 52 mg injection of Rocuronium	|<span class="success">	2	</span>|<span class="warning">	0	</span>|<span class="danger">	0	</span>|
|	Sarin	|	Exposure to 5 concentrations in the environment	|<span class="success">	21	</span>|<span class="warning">	4	</span>|<span class="danger">	0	</span>|
...
|	Tranexamic Acid	|	Administer 200 mg of TXA	|<span class="success">	8	</span>|<span class="warning">	0	</span>|<span class="danger">	0	</span>|
|	Vasopressin	|	Ramp dose of vasopressin from 0.04 to 0.18 to 0.25 ug	|<span class="success">	3	</span>|<span class="warning">	2	</span>|<span class="danger">	0	</span>|
|		|	Total	|<span class="success">	94	</span>|<span class="warning">	15	</span>|<span class="danger">	0	</span>|
...
|	Administer Naloxone - 200 ug -  in response to Fentanyl	|	Naloxone is modeled as a competitive inhibitor of opioids; it exhibits minimal PD effects alone	|	30 = 300 ug Fentanyl; 300 = 200 ug Naloxone	|	250; 1000	|<span class="success">	Return to resting state @cite goodman1996goodman	</span>|<span class="success">	Return to resting state @cite goodman1996goodman	</span>|<span class="success">	Return to resting state @cite goodman1996goodman	</span>|<span class="success">	Return to resting baseline @cite goodman1996goodman	</span>|<span class="success">	Increase  	</span>|
